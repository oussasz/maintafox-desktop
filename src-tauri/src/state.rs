...
use crate::jobs::ComputationJobRunner;
...
pub struct AppState {
    ...
    /// Async computation jobs (progress + cooperative cancel).
    pub computation_jobs: ComputationJobRunner,
...
impl AppState {
    ...
    pub fn new(db: DbPool) -> Self {
        Self {
            ...
            computation_jobs: ComputationJobRunner::new(),
