...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        .await?;
        db.execute_unprepared("ALTER TABLE work_orders ADD COLUMN source_ishikawa_flow_node_id TEXT NULL")
            .await?;
        db.execute_unprepared("ALTER TABLE work_orders ADD COLUMN source_rca_cause_text TEXT NULL")
            .await?;
        db.execute_unprepared(
        ...
        .await?;
        db.execute_unprepared("ALTER TABLE fmeca_items ADD COLUMN source_ishikawa_flow_node_id TEXT NULL")
            .await?;
        db.execute_unprepared(
