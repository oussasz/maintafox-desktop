...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let catalog: &[(&str, &str, &str, i32, i32)] = &[
            ...
            (
                "iot.configure",
                "Configure IoT devices, rules, and mapping",
                "iot",
                1,
                1,
            ),
            ...
            (
                "erp.configure",
                "Configure ERP mappings and sync contracts",
                "erp",
                1,
                1,
            ),
            ...
            (
                "fin.report",
                "Generate governed finance reports and exports",
                "fin",
                0,
                0,
            ),
        ...
        tracing::info!(count = catalog.len(), "migration_029::permission_catalog_seeded");
