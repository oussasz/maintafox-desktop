...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::product_license::get_product_activation_token,
            ...
            commands::diagnostics::seed_rams_sql_demo_data,
            commands::diagnostics::seed_rams_presentation_data,
            ...
            commands::org::reconcile_org_draft_lineage,
            ...
            commands::personnel::get_position,
            commands::personnel::upsert_position,
            commands::personnel::archive_position,
            commands::personnel::create_position,
            commands::personnel::get_position_requirement_seed,
            commands::personnel::list_personnel_assignment_history,
            commands::personnel::upload_personnel_photo,
            commands::personnel::get_personnel_availability_state,
            ...
            commands::inventory::get_inventory_purchase_order_detail,
            commands::inventory::project_inventory_stock_impact,
            ...
            commands::inventory::get_inventory_repairable_order_detail,
            commands::inventory::evaluate_inventory_repair_vs_replace,
            ...
            // ── Supplier commands ────────────────────────────────────────────────────────
            commands::inventory::list_inventory_suppliers,
            commands::inventory::get_inventory_supplier,
            commands::inventory::upsert_inventory_supplier,
            commands::inventory::deactivate_inventory_supplier,
            commands::inventory::list_supplier_article_sources,
            commands::inventory::upsert_supplier_article_source,
            commands::inventory::delete_supplier_article_source,
            commands::inventory::list_supplier_prices,
            commands::inventory::upsert_supplier_price,
            commands::inventory::get_inventory_supplier_scorecard,
            commands::inventory::list_supplier_contacts,
            commands::inventory::upsert_supplier_contact,
            commands::inventory::delete_supplier_contact,
            commands::inventory::list_supplier_purchase_history,
            // ── Article equivalents ──────────────────────────────────────────────────────
            commands::inventory::list_inventory_article_equivalents,
            commands::inventory::upsert_inventory_article_equivalent,
            commands::inventory::delete_inventory_article_equivalent,
            commands::inventory::list_inventory_article_purchase_history,
            // ── Replenishment ─────────────────────────────────────────────────────────────
            commands::inventory::evaluate_inventory_replenishment,
            commands::inventory::calculate_inventory_abc,
            commands::inventory::calculate_inventory_xyz,
            // ── Procurement dashboard ─────────────────────────────────────────────────────
            commands::inventory::get_procurement_dashboard_summary,
            commands::inventory::get_procurement_alerts,
            commands::inventory::get_article_consumption_monthly,
            // ── Repairable history ────────────────────────────────────────────────────────
            commands::inventory::get_inventory_article_repairable_history,
            // ── Document links ────────────────────────────────────────────────────────────
            commands::inventory::list_inventory_document_links,
            commands::inventory::upsert_inventory_document_link,
            // ── WO material readiness ─────────────────────────────────────────────────────
            commands::inventory::check_wo_part_stock_availability,
            commands::inventory::create_procurement_requisition_from_wo_part,
            commands::inventory::suggest_inventory_internal_transfer,
            ...
            commands::reference::get_reference_governance_capabilities,
            commands::reference::get_reference_governance_capabilities_by_code,
            ...
            commands::reference::discard_draft_reference_set,
            ...
            commands::reference::create_operational_reference_value,
            commands::reference::update_reference_value,
            commands::reference::deactivate_reference_value,
            commands::reference::reactivate_reference_value,
            ...
            commands::reference::get_schedule_pattern,
            commands::reference::upsert_schedule_pattern,
            ...
            commands::assets::get_equipment_taxonomy_catalog,
            ...
            commands::assets::list_asset_history_events,
            commands::assets::get_asset_history_summary,
            ...
            commands::assets::decommission_asset,
            ...
            commands::assets::read_asset_photo_preview,
            ...
            commands::di::close_di,
            commands::di::cancel_own_di,
            commands::di::reject_di,
            commands::di::close_di_as_non_executable,
            commands::di::approve_di,
            commands::di::defer_di,
            commands::di::reactivate_di,
            commands::di::archive_di,
            ...
            commands::di::upload_di_attachment_from_path,
            commands::di::read_di_attachment_preview,
            ...
            commands::wo::update_work_order_type,
            commands::wo::delete_work_order_type,
            commands::wo::list_work_order_priorities,
            commands::wo::update_work_order_priority,
            commands::wo::list_work_order_statuses,
            commands::wo::update_work_order_status,
            commands::wo::list_wo,
            commands::wo::get_wo,
            ...
            commands::wo::evaluate_wo_completion_gates,
            ...
            commands::wo::mark_part_not_used,
            commands::wo::confirm_no_parts,
            commands::wo::unconfirm_no_parts,
            ...
            commands::wo::get_wo_plan_adherence,
            commands::wo::list_wo_execution_events,
            commands::wo::list_wo_tools,
            commands::wo::add_wo_tool,
            commands::wo::mark_wo_tool_used,
            commands::wo::mark_wo_tool_not_used,
            ...
            commands::advanced_rams::get_weibull_dashboard_payload,
            ...
            commands::advanced_rams::get_suggested_parts_for_failure,
