# Installer Upgrade Uninstall And Repair Quality
...
- **Installer** — WiNS / MSI / dmg quality checklist.
- **Upgrade** — Migration on upgrade.
- **Uninstall** — Clean removal + data retention policy.
...
**[STATUS]:** Phase 5 05-security-review-code-signing-packaging-and-installer-quality — Sprint 03 — Installer Upgrade Uninstall And Repair Quality
...
2. **Installer** — WiNS / MSI / dmg quality checklist.
3. **Upgrade** — Migration on upgrade.
4. **Uninstall** — Clean removal + data retention policy.
