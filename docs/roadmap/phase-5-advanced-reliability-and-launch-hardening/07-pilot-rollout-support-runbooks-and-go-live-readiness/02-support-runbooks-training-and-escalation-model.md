# Support Runbooks Training And Escalation Model
...
- **Runbooks** — P1–P4 response, log bundle request.
- **Training** — Support team curriculum.
...
**[STATUS]:** Phase 5 07-pilot-rollout-support-runbooks-and-go-live-readiness — Sprint 02 — Support Runbooks Training And Escalation Model
...
2. **Runbooks** — P1–P4 response, log bundle request.
3. **Training** — Support team curriculum.
