# Dashboard Widgets Charts And Drill Throughs
...
- **Widgets** — Composable dashboard layout save per user.
- **Charts** — D3 components wired to queries.
- **Performance** — Snapshot queries for heavy KPIs.
...
**[STATUS]:** Phase 5 03-analytics-dashboards-exports-and-reporting-finalization — Sprint 02 — Dashboard Widgets Charts And Drill Throughs
...
2. **Widgets** — Composable dashboard layout save per user.
3. **Charts** — D3 components wired to queries.
4. **Performance** — Snapshot queries for heavy KPIs.
