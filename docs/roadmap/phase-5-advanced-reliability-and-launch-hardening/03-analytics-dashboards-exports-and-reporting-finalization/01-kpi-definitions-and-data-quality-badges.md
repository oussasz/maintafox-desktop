# KPI Definitions And Data Quality Badges
...
- **KPI spec** — Central definitions file in Rust + TS.
- **Badges** — Quality warnings on widgets.
- **Drill-through** — Links to evidence screens.
...
**[STATUS]:** Phase 5 03-analytics-dashboards-exports-and-reporting-finalization — Sprint 01 — KPI Definitions And Data Quality Badges
...
2. **KPI spec** — Central definitions file in Rust + TS.
3. **Badges** — Quality warnings on widgets.
4. **Drill-through** — Links to evidence screens.
