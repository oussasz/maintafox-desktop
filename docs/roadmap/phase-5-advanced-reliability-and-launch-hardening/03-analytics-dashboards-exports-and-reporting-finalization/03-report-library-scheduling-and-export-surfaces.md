# Report Library Scheduling And Export Surfaces
...
- **Library** — Report templates registry.
- **Schedule** — Cron + background job + local store.
- **Export** — PDF/XLSX from Rust.
...
**[STATUS]:** Phase 5 03-analytics-dashboards-exports-and-reporting-finalization — Sprint 03 — Report Library Scheduling And Export Surfaces
...
2. **Library** — Report templates registry.
3. **Schedule** — Cron + background job + local store.
4. **Export** — PDF/XLSX from Rust.
